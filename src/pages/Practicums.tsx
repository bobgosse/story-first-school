...
const YEAR_CARDS: YearCard[] = [
  {
    ...
    description: [
      ...
      'The constraint is the curriculum. Every limitation of a phone camera forces a story decision: what matters enough to frame? What do you cut? What do you ask the audience to imagine? Year 1 students leave with their first understanding of what it means to make a story choice under pressure.',
    ],
  ...
  },
  {
    ...
    description: [
      ...
      'The cameras are modest. The lighting package is small. The new variable is collaboration \u2014 learning to protect a story\u2019s intention while incorporating the contributions of a cinematographer, a sound recordist, an editor. Year 2 students leave with their first understanding of what it means to lead and follow in service of a shared story.',
    ],
