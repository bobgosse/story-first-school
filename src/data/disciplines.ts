...
export const DISCIPLINES: Discipline[] = [
  ...
  },
  {
    slug: 'producing',
    name: 'Producing',
    primaryFunction: 'Horizontal across all six',
    functionColor: '#0D6B52',
    mission: 'The producer is the person who makes it possible for the story to exist — present across the entire pipeline, from ideation through delivery, protecting the creative work at every stage.',
    whatItDoes: 'Producing is not a single column in the pipeline. It is a horizontal presence across all six story functions: shaping ideation and script development, leading casting and protecting performance, hiring the crew whose taste and skill carry the vision and sound, overseeing editorial and post, and ultimately stewarding marketing and delivery. Every decision a producer makes is a story decision, made at a different point in the lifecycle.',
    intersections: 'Ideation & Composition: the producer is in the room when the story is chosen and shaped. Performance & Realization: the producer leads casting and protects the conditions under which performance happens. Managing Element Complexity: the producer leads logistics, schedule, and budget. Vision: crew hiring and editorial oversight are story decisions. Sound: sonic storytelling requires the producer\'s logistical and creative protection. History: the producer stewards how the work enters the industry, the festival circuit, and the culture through marketing and delivery. Producing runs across the entire pipeline.',
    rebuildAsks: 'Producing courses must reframe every logistical skill as a story skill across every phase of production. A budget is not a spreadsheet — it is a set of choices about what the story gets. A casting decision is a story decision. A delivery and marketing strategy is a story decision. The rebuild asks producing students to articulate the story logic behind every decision they make at every point in the pipeline.',
    centralQuestion: 'What does this story need at every stage of its life, and how do we protect it from first idea to final delivery?',
  },
  {
    slug: 'cinematography',
    name: 'Cinematography',
