...
export const DISCIPLINES: Discipline[] = [
  ...
  },
  {
    ...
    intersections: 'All six. Directing is the most cross-functional discipline in the school — it must understand composition, sound, performance, logistics, and cultural context simultaneously.',
  ...
  },
  {
    ...
    intersections: 'All six. Producing is the most institutionally cross-functional discipline because it must communicate fluently with every other craft.',
  ...
  },
  {
    ...
    intersections: 'Vision (primary), Performance & Realization (the relationship between camera and performance), Ideation & Composition (visual storytelling is a form of composition), Sound (image and sound create meaning together).',
  ...
  },
  {
    ...
    primaryFunction: 'Vision',
    functionColor: '#6B3FA0',
    mission: 'The editor is the final author of the story\'s rhythm, structure, and emotional arc — the person who shapes the viewer\'s experience of time.',
    whatItDoes: 'Editing trains the understanding that story happens in time, and that the manipulation of time is the manipulation of meaning. Every cut is a choice about what the audience feels, what they know, and when they know it. Editing is not assembly — it is the final act of story construction.',
    intersections: 'Vision (primary), Ideation & Composition (structure and rhythm), Performance & Realization (the editor shapes how performances land), Sound (picture and sound edit are inseparable).',
  ...
  },
  {
    ...
    intersections: 'Vision (primary), Ideation & Composition (world-building is a form of story design), Performance & Realization (the set is the actor\'s instrument).',
  ...
  },
  {
    ...
    intersections: 'Vision (primary), Ideation & Composition (animation is often the writer and director as well as the image-maker), Performance & Realization (animated performance is crafted, not captured), Managing Element Complexity (animated production has its own complex pipeline).',
